...
3 초	256 MB	26970	10940	7375	38.137%
...
사회망에서 사람들의 친구 관계는 그래프로 표현할 수 있는데,
이 그래프에서 사람은 정점으로 표현되고,
...
public class Exam_2533 {
    public static void main(String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));

        int N = Integer.parseInt(br.readLine());

        ArrayList<Integer>[] listInList = new ArrayList[N + 1];

        for(int i = 0; i < N; i++)
            listInList[i + 1] = new ArrayList<>();
